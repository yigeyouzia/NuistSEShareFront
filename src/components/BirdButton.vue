...
<template>
  <div class="grid place-content-center mt-8 p-7">
    <div class="w-50">
      <div class="birdButton ">
        <div class="content">
          <div class="buttonWrapper" @click="download">
            <span>开始下载</span>
          </div>
          <div class="birdBox">
...
.birdButton {
  .content {
    ...
    $primary-color: $base-index-title-color;
    $border-color: #000;
    ...
    border-radius: 30px;
    @include background_color("themeHomeButtonColor");
    cursor: pointer;
    position: relative;
    ...
    .buttonWrapper {
      ...
      &::after {
        ...
        @include background_color("themeHomeButtonMountainColor");
