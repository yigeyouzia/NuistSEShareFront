...
<template>
  <div icon-btn i-carbon-sun @click="toggleDark()" />
  <main px-16 py-40 text-center>
    <i i-logos-unocss text-48 inline-block />
    <p mt-15 text-20 font-bold color-gray-400>
      UnoCSS 指北
    </p>
    <i icon-btn dark:i-carbon-moon i-carbon-sun @click="toggleDark()">
      切换颜色
    </i>
    ...
    <p mt-20 text-14 color-gray-400>
      Flex骰子
    </p>
  </main>
</template>
